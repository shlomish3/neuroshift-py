...
function Set-MonthSheetEventCode {
    ...
    # Keep the month sheet event module empty.
    # Worksheet_Change / Worksheet_Calculate macros clear Excel's Undo stack.
    # Duplicate highlighting is generated by Python conditional formatting now.
}
